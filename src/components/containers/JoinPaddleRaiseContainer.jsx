...
const SESSION_ID_DESCRIPTION = 'The Session ID (in ALL CAPS) will be provided during the livestream. If you missed the ID, please comment in the livestream chat. '
